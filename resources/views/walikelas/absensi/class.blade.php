...
<div class="d-flex flex-wrap align-items-center gap-2">
    <a href="{{ route('guru.absensi.index', ['date' => $tanggal ?? date('Y-m-d')]) }}" class="btn btn-light border rounded-3 px-3 py-1.5 d-inline-flex align-items-center gap-1.5 shadow-2xs text-secondary fw-semibold" style="font-size: 0.85rem;" title="Kembali">
        <i class='bx bx-chevron-left'></i> Kembali
    </a>

    <form method="GET" action="{{ route('guru.absensi.show', $selectedClass->id ?? 1) }}" class="m-0">
