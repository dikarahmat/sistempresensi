...
<div class="header-action-btns d-none d-md-flex">
    <!-- Tombol Mode Gerbang (Direct ke Kiosk / Scanner Gerbang Guru) -->
...
<div class="pt-0.5 sm:pt-1 pb-4 space-y-2 sm:space-y-3">
    ...
    @php
        $listKelas = $classSummaries ?? $classesSummary ?? $classes ?? $kelasList ?? [];
    ...
    <div class="badges-scroll-container mb-3 no-scrollbar d-none d-md-block" style="scrollbar-width: none; -ms-overflow-style: none;">
        <div class="badges-scroll-wrapper">
            ...
            <div class="status-badge-pill shadow-2xs">
                <span><strong>{{ $totalSiswaSeluruhnya ?? $totalSiswa ?? $sumTotal }}</strong> total siswa</span>
    ...
    <div class="row g-2 sm:g-3 align-items-start">
        ...
        <div class="col-12">
            <div class="alert alert-primary d-flex align-items-center justify-content-between py-2 px-3 mb-3 rounded-3 shadow-xs">
                ...
                <a href="{{ route('guru.absensi.index', ['tanggal' => $tanggal ?? date('Y-m-d')]) }}" class="btn btn-sm btn-light border text-dark fw-semibold py-1 px-2.5 rounded-2" style="font-size: 0.78rem;">
                        ...
                        <tbody class="text-nowrap">
                            ...
                            <tr class="{{ $loop->odd ? 'baris-abu' : 'baris-putih' }} text-nowrap">
                                ...
                                <td class="text-center align-middle col-td-aksi text-nowrap">
                                    <div class="d-flex align-items-center justify-content-center w-100 text-nowrap">
                                        <a href="{{ route('guru.absensi.show', ['schoolClass' => $clsId, 'tanggal' => $tanggal ?? date('Y-m-d')]) }}" class="btn-buka-kelas text-nowrap">
                            ...
                            @empty
                            <tr class="text-nowrap">
                                <td colspan="8" class="text-center py-4 text-secondary text-nowrap">
                                    <i class='bx bx-info-circle fs-3 d-block mb-1 text-muted'></i>
                                    Belum ada data kelas binaan yang ditetapkan untuk akun Anda.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
