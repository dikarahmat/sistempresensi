...
<div class="d-flex gap-2">
    ...
    @endif
    <a href="{{ route('guru.students') }}" class="btn-back-white shadow-xs">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-5">
            <div class="card card-modern p-4">
                ...
                <a href="{{ route('guru.students.download-qr', $student->id) }}" class="btn-download-blue">
                    <i class='bx bx-download fs-5'></i> Download
                </a>

                <!-- Tombol Download Kartu Presensi PDF -->
                <a href="{{ route('guru.students.download-card', $student->id) }}" class="btn-download-green" id="btnDownloadCard" style="text-decoration: none;">
