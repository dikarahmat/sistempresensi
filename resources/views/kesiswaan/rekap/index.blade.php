...
<div class="d-none d-md-block">
    <div class="d-flex align-items-center gap-1 gap-md-2">
        ...
        <a href="{{ route('kesiswaan.rekap.export-excel', $exportParams) }}" 
        ...
        <a href="{{ route('kesiswaan.rekap.export-pdf', $exportParams) }}" 
           class="btn-red-pdf" 
...
@endphp
    ...
    <div class="d-block d-md-none mb-3">
        <div class="card border border-light-subtle shadow-sm rounded-3 p-3 bg-white">
            ...
            <div class="row g-2">
                ...
                <!-- 3. Periode Harian -->
                <div class="col-4">
                    <a href="{{ route('kesiswaan.rekap.index', array_merge(request()->except('type'), ['type' => 'harian'])) }}"
                ...
                <!-- 4. Periode Mingguan -->
                <div class="col-4">
                    <a href="{{ route('kesiswaan.rekap.index', array_merge(request()->except('type'), ['type' => 'mingguan'])) }}"
                ...
                <!-- 5. Periode Bulanan -->
                <div class="col-4">
                    <a href="{{ route('kesiswaan.rekap.index', array_merge(request()->except('type'), ['type' => 'bulanan'])) }}"
            ...
            <form method="GET" action="{{ route('kesiswaan.rekap.index') }}" class="m-0">
    ...
    <div class="d-none d-md-block">
        ...
        <div class="filter-card">
            <form method="GET" action="{{ route('kesiswaan.rekap.index') }}" class="row g-2 align-items-end">
                <input type="hidden" name="type" value="{{ $type }}">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $loop->odd ? 'baris-abu' : 'baris-putih' }}">
                            ...
                            <td class="text-start text-truncate" style="max-width: 200px;">
                                <a href="{{ route('kesiswaan.students.show', $st->id) }}" class="text-decoration-none text-dark">
                                    {{ $st->name }}
                                </a>
                            </td>
                ...
                <table class="table table-hover align-middle mb-0 table-matrix table-zebra-custom text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $loop->odd ? 'baris-abu' : 'baris-putih' }}">
                            ...
                            <td>{{ $student->nis }}</td>
                            <td class="text-start text-truncate" style="max-width: 200px;">
                                <a href="{{ route('kesiswaan.students.show', $student->id) }}" class="text-decoration-none text-dark">
                                    {{ $student->name }}
                                </a>
                            </td>
