    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 bg-white">
        ...
        <div class="p-3.5 p-md-4 border-bottom border-gray-100 bg-white">
            <div class="action-bar-section">
                ...
                <form method="GET" action="{{ route('kesiswaan.students.index') }}" class="d-flex flex-column flex-md-row gap-2 w-100 m-0">
                    <!-- Search Bar -->
                    ...
                    <div class="w-100 w-md-auto">
                        <a href="{{ route('kesiswaan.students.index') }}" class="btn btn-light d-inline-flex align-items-center justify-content-center px-2.5 flex-shrink-0 w-100 w-md-auto" style="height: 38px; border-radius: 6px; font-size: 0.85rem;" title="Reset Filter">
                    ...
                    <tr class="align-middle {{ $loop->odd ? 'baris-abu' : 'baris-putih' }}">
                        ...
                        <td class="text-center text-nowrap px-3">
                            <div class="crud-center-wrapper">
                                <a href="{{ route('kesiswaan.students.show', $student->id) }}" class="btn btn-sm btn-success" title="Detail">
...
<div class="modal fade" id="printCardsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form action="{{ route('kesiswaan.students.print-cards') }}" method="POST">
                @csrf
