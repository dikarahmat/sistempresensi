...
@section('content')
    ...
    <div class="d-block d-md-none mb-3">
        <div class="card border border-light-subtle shadow-sm rounded-3 p-3 bg-white">
            ...
            <form method="GET" action="{{ route('kesiswaan.students.index') }}" class="m-0">
    ...
    <div class="d-none d-md-block">
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            <div class="card-body p-3">
                <form method="GET" action="{{ route('kesiswaan.students.index') }}" class="row g-2 align-items-center">
                    ...
                    <div class="col-12 col-md-auto">
                        <a href="{{ route('kesiswaan.students.index') }}" class="btn btn-outline-secondary py-2 px-3 rounded-3">Reset</a>
                    </div>
                    @endif
