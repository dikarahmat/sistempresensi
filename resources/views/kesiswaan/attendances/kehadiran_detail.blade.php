...
<div class="d-flex align-items-center gap-2">
    <a href="{{ route('kesiswaan.kehadiran') }}" class="btn btn-light border rounded-3 px-3 py-1.5 d-inline-flex align-items-center gap-1.5 shadow-2xs text-secondary fw-semibold" style="font-size: 0.85rem;" title="Kembali">
