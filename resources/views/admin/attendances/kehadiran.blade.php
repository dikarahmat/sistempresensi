                    ...
                    <tr class="{{ $loop->odd ? 'baris-abu' : 'baris-putih' }}">
                        ...
                        <td class="text-center text-nowrap">
                            <div class="d-inline-flex align-items-center justify-content-center gap-1.5 flex-nowrap">
                                ...
                                <a href="{{ route('admin.absensi.index', ['class_id' => $item->id]) }}" class="btn-action-presensi" title="Buka Presensi Hari Ini {{ $shortName }}">
                                    <i class='bx bx-qr-scan fs-6'></i>
                                    <span>Presensi</span>
                                </a>

                                {{-- Tombol Lihat (Lengkap dengan Ikon Mata bx-show & Kontainer Asli) --}}
                                <a href="{{ route('admin.kehadiran.detail', $item->id) }}" class="btn-action-lihat" title="Lihat Rekap Histori {{ $shortName }}">
